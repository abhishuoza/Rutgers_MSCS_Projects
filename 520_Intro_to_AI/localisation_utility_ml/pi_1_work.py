...
plt.title("Ship Configuration for pi_1")
plt.show()

# Optional initial state logging header
# with open("datasets/localisation_dataset_pi_1.csv", mode="w", newline="") as file:
...
for test in range(50000):
    ...
    # with open("datasets/localisation_dataset_pi_1.csv", mode="a", newline="") as file:
    #     writer = csv.writer(file)
